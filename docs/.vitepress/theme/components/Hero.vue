...
const installCommand = 'brew install izdrail/chief/chief'
    ...
    <div class="hero-container">
      ...
      <div class="hero-content">
        ...
        <div class="hero-actions">
          ...
          <a href="https://github.com/izdrail/chief" target="_blank" rel="noopener" class="btn-secondary">
        ...
        <div class="terminal-window">
          ...
          <div class="terminal-body">
            <div class="terminal-line line-1">
              ...
              <span class="terminal-command typing-1">brew install izdrail/chief/chief</span>
            </div>
            <div class="terminal-line line-2">
              <span class="terminal-output output-1">==> Fetching izdrail/chief/chief</span>
            </div>
