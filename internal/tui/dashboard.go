...
func (a *App) renderErrorPanel(width, height int) string {
	...
	content.WriteString(hintStyle.Render("💡 Tip: Check ollama.log in the PRD directory for full details."))
	content.WriteString("\n\n")
...
func (a *App) renderEmptyPRDPanel(width, height int) string {
	...
	content.WriteString(" to edit this PRD with Ollama\n")
	content.WriteString("• Press ")
	content.WriteString(ShortcutKeyStyle.Render("n"))
	content.WriteString(" to create a new PRD with Ollama\n")
	content.WriteString("\n")
